...
class TwitterClient(object):
    ...
    def __init__(self):
        ...
        '''
        # keys and tokens from the Twitter Dev App (Generated on app creation)
        # Please be aware that I will be deleting these keys after the 20th June 2020 as they are
...
def main():
    ...
    tweets = api.get_tweets(query='Lebanon', count=100)
